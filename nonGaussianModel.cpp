...
NonGaussianModel::NonGaussianModel(Util* u){
  util = u;
...
NonGaussianModel::~NonGaussianModel(){}
...
void NonGaussianModel::setupTextures(){
...
void NonGaussianModel::setupEmitters(){
